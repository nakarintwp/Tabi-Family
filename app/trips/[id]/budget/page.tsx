...
export default async function BudgetPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <main className="shell"><div className="container"><AppHeader />
    <div className="planner-topbar"><Link href={`/trips/${id}/wallet`} className="back-link">‹ Wallet</Link><span className="planner-counter">V10.6 Expense & Split</span></div>
    ...
    <WalletHubTabs tripId={id} active="expenses" />
