...
export default async function WeatherPage({ params, searchParams }: { params: Promise<{ id: string }>; searchParams: Promise<{ city?: string }> }) {
  ...
  return <main className="shell"><div className="container"><AppHeader />
    ...
    <div className="page-head-row"><div><span className="eyebrow">FREE WEATHER · NO API KEY</span><h1 className="page-title">Weather & Rain Plan</h1><p className="page-subtitle">พยากรณ์ 7 วันจาก Open-Meteo พร้อมเตือนกิจกรรมกลางแจ้ง</p></div></div>
