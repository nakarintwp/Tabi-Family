...
export const DISCOVERY_GUIDES: Record<string, DiscoveryGuide> = {
  ...
  "mont-deus-snow-park": { thaiTitle: "Mont Deus Park Ski Resort / มงเดอุส พาร์ค", nearestStation: "Takayama Station", accessNote: "ขับรถจากตัวเมือง Takayama ประมาณ 20 นาที", hoursNote: "เปิดเฉพาะฤดูหนาวและขึ้นกับปริมาณหิมะ", closedNote: "ตรวจวันเปิดฤดูกาล 2026-27 ก่อนเดินทาง", budgetNote: "ค่าเล่นหิมะ/เช่าอุปกรณ์/ลิฟต์คิดตามกิจกรรม", reservationNote: "เล่นหิมะทั่วไปไม่จำเป็นต้องจอง แต่คลาส/กิจกรรมควรตรวจล่วงหน้า", bestTime: "09:00–13:00", familyNote: "ใกล้ตัวเมือง เหมาะกับเด็ก มีเลื่อนหิมะและพื้นที่เล่นหิมะ", parkingNote: "มีลานจอดรถขนาดใหญ่; รถเช่าฤดูหนาวควรใช้ยางหิมะ", weatherNote: "กิจกรรมขึ้นกับหิมะ ลม และสภาพถนน" },
  "hounoki-daira-snow": { thaiTitle: "Hida Hounoki Daira Ski Resort / โฮโนะคิไดระ", nearestStation: "Takayama Station", accessNote: "ขับรถประมาณ 40 นาทีไปทาง Norikura / Hirayu", hoursNote: "ฤดูหนาวเท่านั้น; เวลาเปิดอาจเปลี่ยนตามสภาพอากาศ", closedNote: "ตรวจ snow report และวันเปิดล่าสุด", budgetNote: "ลิฟต์/เช่าอุปกรณ์/กิจกรรมหิมะคิดแยก", reservationNote: "Snow rafting และ snow hike บางโปรแกรมควรจองล่วงหน้า", bestTime: "09:00–14:00", familyNote: "มีทั้งเล่นหิมะ สกี และกิจกรรมอย่าง snow rafting; เหมาะทำเป็นครึ่งวันหรือเต็มวัน", parkingNote: "มีลานจอดรถ; ฤดูหนาวควรใช้ยางหิมะ", weatherNote: "พื้นที่สูง อากาศหนาวกว่าตัวเมืองและสภาพถนนเปลี่ยนเร็ว" },
  "hirayu-onsen-ski-area": { thaiTitle: "Hirayu Onsen Ski Area / ลานสกีฮิรายุออนเซ็น", nearestStation: "Takayama Station", accessNote: "อยู่ Okuhida Onsen-go เหมาะขับรถต่อจาก Hounoki Daira หรือเที่ยว Hirayu", hoursNote: "เปิดตามฤดูหิมะ", closedNote: "ตรวจวันเปิดและสภาพลิฟต์ล่าสุด", budgetNote: "ค่าลิฟต์/เช่าอุปกรณ์แยก; ออนเซ็นคิดตามสถานที่", reservationNote: "ทั่วไปไปหน้างานได้ แต่ควรตรวจคลาสและ rental ก่อน", bestTime: "เช้า–บ่าย", familyNote: "มี family slope และเล่นเลื่อนหิมะได้ เหมาะปิดท้ายด้วยออนเซ็น", parkingNote: "มีที่จอดใกล้ลานสกี; ถนนฤดูหนาวต้องเตรียมรถให้พร้อม", weatherNote: "หิมะและอุณหภูมิอาจต่ำมากใน Okuhida" },
  "shinhotaka-snowshoe": { thaiTitle: "Shinhotaka Ropeway & Snowshoe / ชินโฮทากะโรปเวย์", nearestStation: "Takayama Station", accessNote: "ขับรถประมาณ 80 นาทีถึง Okuhida; มีรถบัสตามฤดูกาล", hoursNote: "ฤดูหนาว Ropeway โดยทั่วไปเปิดช่วงกลางวัน; snowshoe เป็นกิจกรรมตามฤดูกาล", closedNote: "Ropeway อาจหยุดเพราะลมแรง/ซ่อมบำรุง", budgetNote: "ค่า Ropeway และกิจกรรม snowshoe คิดแยก", reservationNote: "Snowshoe tour ควรตรวจรอบและจองล่วงหน้า", bestTime: "09:30–13:30", familyNote: "เหมาะกับครอบครัวที่อยากสัมผัสหิมะและวิว Japan Alps มากกว่าการเล่นสกี", parkingNote: "ฤดูหิมะลาน Nabedaira บางส่วนปิด; ตรวจที่จอดรถก่อนขับไป", weatherNote: "ลมแรงอาจกระทบการเดิน Ropeway" },
  "arkopia-mountain-park-snow": { thaiTitle: "ARKOPIA MOUNTAIN PARK / อาร์โคเปีย เมาน์เทนพาร์ก", nearestStation: "Kuguno Station / Takayama", accessNote: "อยู่โซน Kuguno ทางใต้ของ Takayama", hoursNote: "กิจกรรมหิมะเปิดตามปฏิทินฤดูหนาว/อีเวนต์", closedNote: "ตรวจปฏิทินล่าสุดก่อนเดินทาง", budgetNote: "ค่าพื้นที่/กิจกรรมขึ้นกับวันจัดงาน", reservationNote: "บางกิจกรรมอาจต้องจอง", bestTime: "10:00–14:00", familyNote: "บางช่วงมีโซนเล่นหิมะ เลื่อน และ snow tube เหมาะกับเด็ก", parkingNote: "มีพื้นที่จอดรถบริเวณรีสอร์ตเดิม", weatherNote: "ตรวจหิมะจริงก่อนเดินทางเพราะกิจกรรมเป็น seasonal" },
  "takasu-snow-park-yukinos": { thaiTitle: "Takasu Snow Park · Yukinos / ทาคาสุ สโนว์พาร์ก", nearestStation: "Takayama Station", accessNote: "Day trip จาก Takayama โดยรถประมาณ 40 นาทีตามข้อมูลการท่องเที่ยวท้องถิ่น", hoursNote: "เปิดฤดูหนาว; โซน Yukinos เป็นพื้นที่เล่นหิมะสำหรับครอบครัว", closedNote: "ตรวจวันเปิดฤดูกาลและสภาพหิมะล่าสุด", budgetNote: "ค่าเข้า/ลิฟต์/กิจกรรมขึ้นกับแพ็กเกจ", reservationNote: "ตรวจเงื่อนไขของโซนเด็กและ rental ก่อนเดินทาง", bestTime: "09:00–14:00", familyNote: "ตัวเลือกเด่นถ้าต้องการเล่นหิมะแบบจริงจัง มี dedicated snow-play area", parkingNote: "มีลานจอดขนาดใหญ่; ต้องเตรียมรถฤดูหนาว", weatherNote: "เส้นทางภูเขาและหิมะควรเช็กก่อนออกจาก Takayama" },
...
export const DISCOVERY_PLACES: DiscoveryPlace[] = [
  ...
  {
    slug: "mont-deus-snow-park",
    title: "Mont Deus Park Ski Resort",
    city: "Takayama",
    area: "Ichinomiya · ~20 min from central Takayama",
    category: "family",
    emoji: "",
    summary: "ลานหิมะที่ใกล้ตัวเมือง Takayama เหมาะกับครอบครัว มีสกี เลื่อนหิมะ และพื้นที่เล่นหิมะสำหรับเด็ก",
    tags: ["winter", "snow", "sled", "kids", "family"],
    durationMinutes: 240,
    childFriendly: true,
    seniorFriendly: true,
    isOutdoor: true,
  ...
  {
    slug: "hounoki-daira-snow",
    title: "Hida Hounoki Daira Ski Resort",
    city: "Takayama",
    area: "Nyukawa · ~40 min from Takayama",
    category: "family",
    emoji: "",
    summary: "พาวเดอร์สโนว์และกิจกรรมฤดูหนาวหลายแบบ นอกจากสกียังมี snow rafting และ snow hike ตามรอบที่เปิด",
    tags: ["winter", "snow", "snow-rafting", "kids", "family"],
    durationMinutes: 300,
    childFriendly: true,
    seniorFriendly: true,
    isOutdoor: true,
    latitude: 36.175725,
    longitude: 137.491922,
  },
  {
    slug: "hirayu-onsen-ski-area",
    title: "Hirayu Onsen Ski Area",
    city: "Takayama",
    area: "Okuhida · Hirayu Onsen",
    category: "family",
    emoji: "",
    summary: "ลานสกีขนาดไม่ใหญ่มากที่มี family slope และเล่นเลื่อนหิมะได้ เหมาะจับคู่กับแช่ออนเซ็น Hirayu",
    tags: ["winter", "snow", "sled", "onsen", "family"],
    durationMinutes: 240,
    childFriendly: true,
    seniorFriendly: true,
    isOutdoor: true,
  ...
  {
    slug: "shinhotaka-snowshoe",
    title: "Shinhotaka Ropeway Snow Experience",
    city: "Takayama",
    area: "Okuhida · Shinhotaka",
    category: "nature",
    emoji: "",
    summary: "ขึ้น Ropeway ชม Japan Alps และเลือกกิจกรรม snowshoe ตามฤดูกาล เหมาะกับคนที่อยากสัมผัสหิมะโดยไม่ต้องเล่นสกี",
    tags: ["winter", "snow", "snowshoe", "nature", "family"],
    durationMinutes: 300,
    childFriendly: true,
    seniorFriendly: true,
    isOutdoor: true,
  ...
  {
    slug: "arkopia-mountain-park-snow",
    title: "ARKOPIA MOUNTAIN PARK Snow Play",
    city: "Takayama",
    area: "Kuguno · South Takayama",
    category: "family",
    emoji: "",
    summary: "พื้นที่ฤดูหนาวในรีสอร์ตเดิม Arkopia บางช่วงมีกิจกรรมเล่นหิมะ เลื่อน และ snow tube เหมาะกับครอบครัว",
    tags: ["winter", "snow", "sled", "tube", "kids"],
    durationMinutes: 180,
    childFriendly: true,
    seniorFriendly: true,
    isOutdoor: true,
  ...
  {
    slug: "takasu-snow-park-yukinos",
    title: "Takasu Snow Park · Yukinos",
    city: "Takayama",
    area: "Takasu / Gujo · Takayama day trip",
    category: "family",
    emoji: "",
    summary: "สโนว์รีสอร์ตขนาดใหญ่ที่มี Yukinos พื้นที่เล่นหิมะสำหรับครอบครัว เหมาะกับวันที่อยากเล่นหิมะแบบเต็มวัน",
    tags: ["winter", "snow", "kids", "family", "ski"],
    durationMinutes: 360,
    childFriendly: true,
    seniorFriendly: true,
    isOutdoor: true,
